...
/**
 * 自定义的JwtAccessTokenConverter 参照 org.springframework.security.oauth2.provider.token.store.JwtAccessTokenConverter
 *
 * @author liutianyang
 * @since 1.0
 */
public class MyJwtAccessTokenConverter implements TokenEnhancer, AccessTokenConverter, InitializingBean {
